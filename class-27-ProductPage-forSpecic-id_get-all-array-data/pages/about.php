<?php include 'pages/header.php' ?>
    ...
    <section class="page-title back-2">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="block">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mt-5 mt-lg-0 ">
                    <div class="pl-0 pl-lg-4 ps-4">
                        <h2>We strive to be the best and <br> make awesome work.</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius enim, accusantium repellat ex autem numquam
                            iure officiis facere vitae itaque.</p>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam qui vel cupiditate exercitationem, ea fuga est
                        ...
                        <a href="contact.html" class="btn btn-warning btn-small">Our Company Profile</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="about-feature bg-secondary ">
        <div class="container ps-4">
            <div class="row pb-5 pt-5 ">
                <div class="col-md-12">
                    <div class="title">
                        <h2 class="agency-heading">We are indepented Design & Development Agency</h2>
                    </div>
                </div>
            </div>
            <div class="row pb-5">
    ...
    <section class="call-to-action bg-1 section-sm overly mb-1">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="block">
                        ...
                        <a class="btn btn-outline-warning btn-main" href="contact.html">Tell Us Your Story</a>
                    </div>
                </div>
            </div>
        </div>
