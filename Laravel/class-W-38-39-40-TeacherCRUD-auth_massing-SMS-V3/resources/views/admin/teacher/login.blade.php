                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6">
                            <div class="card-body p-4 p-sm-5">
                                <h5 class="card-title">Teachers Sign In</h5>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <div class="ms-auto position-relative">
                                                ...
                                                <input type="text" name="user_name" class="form-control radius-30 ps-5" id="inputEmailAddress" placeholder="Email or Phone">
                                            </div>
                                        </div>
                                        <div class="col-12">
