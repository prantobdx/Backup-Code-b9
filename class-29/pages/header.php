...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
        <a href="action.php?page=home" class="navbar-brand">eBazar</a>
        <ul class="navbar-nav">
            ...
            <li class="dropdown"><a href="action.php?page=product" class="nav-link dropdown-toggle text-white" data-bs-toggle="dropdown">Product</a>
